...
class two_domain:
    ...
    def solve(self):
        ...
        for i in range(self.iterations):
            ...
            u1_sol = scipy.sparse.linalg.lsqr(A1, b1)
            #print("d1 r1norm:",u1_sol[3])
            #print("d1 itr:",u1_sol[2])
            ...
            u2_sol = scipy.sparse.linalg.lsqr(A2, b2)
            #print("d2 r1norm:", u2_sol[3])
            #print("d2 itr:", u2_sol[2])
            ...
            self.residual[i, 0] = u1_sol[3]
            self.residual[i, 1] = u2_sol[3]
