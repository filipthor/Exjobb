...
This class holds the overconstraint system for both neumann
and dirichlet conditions on both u1 and u2

Update: Looking at residuals at certain iterations
'''
...
class two_domain:
    ...
    def get_bl1(self,uG,u2): # Here the extra condition is imposed
        ...
        return np.concatenate((r1,uG,r2))
    ...
    def get_bl2(self,u1,uG): # Here the extra condition is imposed
        ...
        return np.concatenate((r3,uG,r4))
